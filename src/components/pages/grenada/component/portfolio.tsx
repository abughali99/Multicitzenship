      ...
      >
        ...
        >
          <div className="py-5">
            ...
            >
              Grenada is the southernmost island in the Antilles archipelago,
              bordering the eastern Caribbean Sea and western Atlantic Ocean
            </motion.h6>
          </div>
        </motion.div>
        ...
        >
          <div className="w-1/4">
            <motion.div className="py-3" variants={fadeInLeft}>
            ...
            >
              ...
              <h6 className="text-white text-xl">English-Grenada Creole</h6>
            </motion.div>
          </div>
          ...
          <div className="w-1/4">
            ...
            >
              ...
              <h6 className="text-white text-xl">Saint George’s</h6>
            </motion.div>
            <motion.div
              className="py-3"
              variants={fadeInLeft}
            ...
            >
              ...
              <h6 className="text-white text-xl">348.5 sq. km</h6>
            </motion.div>
          </div>
