...
import dominica from "@/assets/images/dominica.jpg";

export const HeroGrenada = () => {
  return (
    <section
      className="relative min-h-[50vh] flex items-center justify-center overflow-hidden py-12"
      style={{
        backgroundImage: `url(${dominica.src})`,
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col justify-center items-center text-center relative z-10">
        ...
        The Caribbean country of Grenada, famed for its natural beauty, economic stability, and alluring advantages, offers a route to obtaining worldwide citizenship through its Citizenship by Investment Program.
        </p>
      </div>
