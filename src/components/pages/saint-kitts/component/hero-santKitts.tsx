    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col justify-center items-center text-center relative z-10">
        ...
        <p className="text-gray-200 text-lg md:text-xl max-w-3xl mx-auto mb-8 leading-relaxed">
          Saint Kitts and Nevis offers one of the Caribbean’s best-located citizenship-by-investment programs. This sun-kissed and enchanting twin-island nation flawlessly combines the region’s natural splendors with a distinct, real, and immersive experience.
        </p>
      </div>
