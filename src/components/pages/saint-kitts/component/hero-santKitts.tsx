...
import Saintkitts from "@/assets/images/saint-kitts.jpg";


export const HeroSantKitts = () => {
  // Animation variants
  const fadeInUp = {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url(${Saintkitts.src})`,
    ...
    >
      ...
      >
        <motion.h1
          className="text-[#d8a16f] text-5xl md:text-7xl font-bold mb-6 leading-tight"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Saint Kitts and Nevis offers one of the Caribbean’s best-located
          citizenship-by-investment programs. This sun-kissed and enchanting
          twin-island nation flawlessly combines the region’s natural splendors
          with a distinct, real, and immersive experience.
        </motion.p>
      </motion.div>
