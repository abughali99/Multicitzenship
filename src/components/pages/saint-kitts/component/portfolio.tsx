import Kitts from "@/assets/logo/saint-kitts-and-nevis-5323280_1280 1.png";
        ...
        <div className="w-7xl mx-auto px-4 flex items-center">
          <div className="w-1/4">
            ...
            <div className="py-3">
              ...
              <h6 className="text-white text-xl">English-saint kitts Creole</h6>
            </div>
          </div>
          <div className="w-1/4">
            <div className="py-3">
            ...
            <div className="py-3">
              ...
              <h6 className="text-white text-xl">Basseterre</h6>
            </div>
            <div className="py-3">
              <h2 className="text-[#d8a16f] text-2xl font-bold">Totla Area</h2>
              <h6 className="text-white text-xl"> 261 sq. km</h6>
            </div>
          </div>
          <div className="w-1/2 flex justify-end items-center">
            <div className="flex flex-col items-center ">
              ...
              />
              <h1 className="text-white font-bold text-3xl">47,783</h1>
            </div>
            <Image
              src={Kitts}
              alt="saint lucia"
