      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-5xl lg:text-5xl font-bold  mb-4 text-[#242058]"><span className="text-[#d8a16f]">Our</span> Mission & Values</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="border-0 shadow-lg hover:shadow-xl transition-shadow rounded-xl">
              <div className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  We provide comprehensive guidance through strategic investment programs that lead to second
                  citizenship.
                </p>
              </div>
            </div>
