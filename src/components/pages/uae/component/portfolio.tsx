      ...
      >
        ...
        >
          <div className="py-5">
            ...
            >
              The United Arab Emirates (UAE) is in the southeastern Arabian
              Peninsula, bordered by Saudi Arabia and Oman, with coastlines
              along the Persian Gulf and Gulf of Oman. Its strategic position
              connects Asia, Europe, and Africa, making it a global trade and
              travel hub
            </motion.h6>
          </div>
        </motion.div>
