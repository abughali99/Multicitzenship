...
import SaintLucia from "@/assets/images/saint-lucia.jpg";


export const HeroSantLucia = () => {
  // Animation variants
  const fadeInUp = {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url(${SaintLucia.src})`,
    ...
    >
      ...
      >
        ...
        >
          Saint Lucia has one of the Caribbean’s best-positioned citizenship-by-investment programs. This bright and enchanting island blends all of the region’s tropical beauties with a unique, authentic, and engaging experience.
        </motion.p>
      </motion.div>
