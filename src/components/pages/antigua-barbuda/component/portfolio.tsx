...
import antigua from "@/assets/logo/antigua-and-barbuda.png";
import layer from "@/assets/logo/Layer 1.png";
import Image from "next/image";
import { motion } from "framer-motion";

export const PortfolioAntiguaBarbuda = () => {
  // Animation variants
  const fadeInLeft = {
      ...
      >
        ...
        >
          <div className="py-5">
            ...
            >
              Antigua & Barbuda is east-southeast of Puerto Rico island, and between the Caribbean Sea and the North Atlantic Ocean.
            </motion.h6>
          </div>
        </motion.div>
        ...
        >
          <div className="w-1/4">
            ...
            >
              ...
              <h6 className="text-white text-xl">English</h6>
            </motion.div>
          </div>
          ...
          <div className="w-1/4">
            ...
            >
              ...
              <h6 className="text-white text-xl">East Caribbean Dollar</h6>
            </motion.div>
            <motion.div 
              className="py-3"
              variants={fadeInLeft}
            ...
            >
              ...
              <h6 className="text-white text-xl">St. John's</h6>
            </motion.div>
            <motion.div 
              className="py-3"
              variants={fadeInLeft}
            ...
            >
              ...
              <h6 className="text-white text-xl">442.6 sq. km</h6>
            </motion.div>
          </div>
