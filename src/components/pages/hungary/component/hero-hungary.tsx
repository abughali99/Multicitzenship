    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col justify-center items-center text-center relative z-10">
        ...
        <p className="text-gray-200 text-lg md:text-xl max-w-3xl mx-auto mb-8 leading-relaxed">
         The Hungary Residency by Investment Program is a unique opportunity for individuals seeking a pathway to European residency in a nation celebrated for its rich history, culture, and economic stability
        </p>
      </div>
