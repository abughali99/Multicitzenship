import { Puzzle, Handshake, Users, TrendingUp, ThumbsUp, Shield } from "lucide-react"
...
export const ChooseUs = () => {
    ...
    },
    {
      ...
      description: "With years of experience, we have a deep understanding of the complexity of programs worldwide.",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: "Our leverage of industry insights gives us a competitive edge to deliver on our commitments.",
    },
  ]
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="py-5">
            <h2 className="text-[#242058] text-3xl sm:text-5xl md:text-6xl font-bold mb-4">
              Why Choose<span className="text-[#d8a16f]"> Us</span>
            </h2>
            <h3 className=" text-5xl sm:text-7xl md:text-5xl font-bold my-4">Reasons to Choose Multicitizenships</h3>
            <p className="text-gray-400">
              We are here to open doors to global opportunities. Unlocking
              borders begins with these word—your passport to limitless
